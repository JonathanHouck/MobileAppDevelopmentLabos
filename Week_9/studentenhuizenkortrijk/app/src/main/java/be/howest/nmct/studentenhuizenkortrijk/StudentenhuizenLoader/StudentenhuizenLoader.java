...
public class StudentenhuizenLoader extends AsyncTaskLoader<Cursor> {
    ...
    public static List<Studentenhuis> lijstStudentenhuizen = null;
    ...
    private void loadCursor() {
        synchronized (lock) {
            ...
            try {
                ...
                lijstStudentenhuizen = new ArrayList();
                ...
                while (reader.hasNext()) {
                    ...
                    while (reader.hasNext()) {
                        ...
                        Studentenhuis huis = new Studentenhuis(adres, huisnummer, gemeente, aantalKamers);
